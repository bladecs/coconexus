...
export default {
  ...
  theme: {
    extend: {
      colors: {
        /* ── Backward-compat brand tokens (used by admin pages) ── */
        brand: {
          50: '#f8eee8', 100: '#f2dccf', 200: '#e9c3ab', 300: '#df9f75',
          400: '#d58351', 500: '#c26939', 600: '#b35e33', 700: '#924c2a',
          800: '#6f3921', 900: '#4d2717',
        },
        coconut: {
          100: '#4a4a4a', 200: '#3f3f3f', 300: '#383838',
          400: '#343434', 500: '#303030',
        },

        /* ── New Design System — CSS variable–backed for dark mode ── */
      ...
      boxShadow: {
        ...
        md:   '0 4px 12px rgba(6, 78, 59, 0.08)',
      },
    },
  },
  plugins: [],
